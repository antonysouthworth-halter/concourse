...
// ExtractQueries is an unnecessarily complex helper to extract a list of
// queries from a top-level query. In particular, it separates any CTE's,
// UNIONs, and subqueries from the main query, since they are each evaluated
// separately when calculating the number of joins.
